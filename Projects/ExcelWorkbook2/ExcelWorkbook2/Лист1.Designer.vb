...
Partial Public NotInheritable Class Лист1
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Лист1", "Лист1")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Лист1 As Лист1
    
    Friend Shared Property Лист1() As Лист1
        Get
            Return _Лист1
        End Get
        Set
            If (_Лист1 Is Nothing) Then
                _Лист1 = value
            Else
